  ...
  return (
    <div className="flex items-center justify-center">
      <div className="w-[570px] h-[337px] rounded-2xl flex flex-col items-center justify-center p-6">
        ...
        <button
          className="mt-6 w-full max-w-[500px] h-14 bg-gray-200 text-black text-[15.49px] rounded-xl flex items-center justify-center gap-2 py-4 hover:bg-gray-300 transition"
