...
import { relevantTokensType, tokenBalances } from '../../hooks/useBalances';
...
export function useDerivedSwapInfo(state: SwapState) {
  ...
  const classicAllowedSlippage = useUserSlippageToleranceWithDefault(1);
